...
const options = {
	method: 'POST',
	headers: {
		'x-rapidapi-key': '1a5cef8240msh86a7c9ef68c6a54p1f93b2jsnce6cddd09f74',
...
// console.log(graphData);
// // We can use push() method to add element in an array
...
.then(data => {
	...
	// For loops are  used to to repetitive task, in this case to print out each individual element in the graphData array and their respective properties
	for (let i = 0; i < 25; i++) {
		graphData.push(
			{
